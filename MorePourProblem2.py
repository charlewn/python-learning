...
def more_pour_problem(capacities, goal, start=None):
	...
	def psuccussors(state):
		...
		#print state
		succ = {}
		for i in indices: #0,1,2,3
			#print state=(0,0,0,0), i = 0, capacities =(1,2,4,8)
...
def replace(sequence, i, val):
	#(0,0,0,0), i = 0, capacities[0] = 1
	s = list(sequence)
	#s = [0,0,0,0]
	s[i] = val
	#s[0] = 1
	#print s = [1,0,0,0]
	return type(sequence)(s) # change back to tuple
