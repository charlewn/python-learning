...
def subway(**lines):
	...
	for index in lines.keys():
		station_line = lines[index].split()
		for station in station_line:
			station_index = station_line.index(station)
			if station_index == 0:
				subway_map.setdefault(station, {})[station_line[station_index+1]] = index
			elif station_index == len(station_line)-1:
				subway_map.setdefault(station, {})[station_line[station_index-1]] = index
			else:
				subway_map.setdefault(station, {})[station_line[station_index+1]] = index
				subway_map.setdefault(station, {})[station_line[station_index-1]] = index
...
def longest_ride(system):
	...
	## your code here
	#print system
	stops = set(a for i in boston.values() for a in i)
