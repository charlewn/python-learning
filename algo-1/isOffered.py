...
def involved(courses, person):
    ...
    for semester in courses:
        for course in courses[semester]:
			for key in courses[semester][course]:
				if courses[semester][course][key] == person:
					if semester in involvedList:
						involvedList[semester].append(course)
					else:
						involvedList[semester] = [course]
    return involvedList
